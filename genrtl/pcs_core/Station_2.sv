...
module Station_2(
  ...
  assign reg_dest_1 = |{ringDataIn_bits_sdest[3], ringDataIn_bits_sdest[1:0]};
  assign _regD_dest = {reg_dest_1, ringDataIn_bits_sdest[2]};
  RegDistributor regD (
    .clock            (clock),
    .reset            (reset),
  ...
  assign _arb_io_in_0_bits_sdest =
    {ringDataIn_bits_sdest[3], 1'h0, ringDataIn_bits_sdest[1:0]};
  RRArbiter arb (
    .clock              (clock),
