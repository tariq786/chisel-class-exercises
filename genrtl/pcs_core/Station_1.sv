...
module Station_1(
  ...
  assign reg_dest_1 = |{ringDataIn_bits_sdest[3:2], ringDataIn_bits_sdest[0]};
  assign _regD_dest = {reg_dest_1, ringDataIn_bits_sdest[1]};
  RegDistributor regD (
    .clock            (clock),
    .reset            (reset),
  ...
  assign _arb_io_in_0_bits_sdest =
    {ringDataIn_bits_sdest[3:2], 1'h0, ringDataIn_bits_sdest[0]};
  RRArbiter arb (
    .clock              (clock),
